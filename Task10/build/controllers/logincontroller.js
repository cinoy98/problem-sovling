...
function Login(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var username, password, service, token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, loginService_1.loginService(username, password)];
                case 1:
                    service = _a.sent();
                    if (service) {
                        token = jsonwebtoken_1.default.sign(username, constants_1.Secret);
